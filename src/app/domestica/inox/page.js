    ...
    <div className="acrilico_main_container">
      ...
      <div className='hero_container'>
        ...
        <div className="hero_text">
          ...
          <p className='hero_description'>Descubre la pureza del agua con nuestros equipos de purificación en acero inoxidable. Con un diseño elegante y duradero, nuestro equipo garantiza una purificación eficaz y confiable. Disfruta de agua limpia y fresca en tu hogar o empresa con nuestra solución moderna y de alta calidad</p>
        </div>
      </div>
      ...
      <div className='characteristic_container'>
            ...
            <p className='characteristic'>- Material de alta calidad en acero inoxidable</p>
