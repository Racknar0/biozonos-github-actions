...
const PopularProducts = () => {
    return (
        <div className="popular_products">
            <h3 className="popular_product_title title_section" data-aos="fade-up">
                Productos Populares
            </h3>
            <h4 className="popular_product_subtitle subtitle_section" data-aos="fade-up">
            ...
            <div className="popular_products_container">
                <div className="popular_product" data-aos="fade-up">
                    ...
                    />
                    <h5 className="title_small popular_product_title">
                        Reemplazo Filtro Bugía AP200
                    </h5>
                    <p className="popular_product_description standard_text_section">
                ...
                <div className="popular_product standard_text_section" data-aos="fade-up">
                    <Image
                        src="/home/white.jpg"
                        alt="producto_ozonos"
                      //  objectPosition="right"
