    ...
    return (
        <div className="industrial_main_container">
            ...
            <div className="main_info">
                <h1 className="title_section main_info_title">Línea Industrial</h1>
                ...
                <ul>
                    <li className='standard_text_section'>SISTEMA DE FILTRACIÒN</li>
                    <li className='standard_text_section'>SISTEMA DE OZONONIZACIÒN</li>
                    <li className='standard_text_section'>SISTEMA DE REFRIGERACIÓN</li>
                </ul>
                <p className="standard_text_section description">
                    ...
                    agua con el cual se procesan los alimentos, es importante
                    esto ya que el no hacerlo conlleva a muchos problemas como
                    la probabilidad de adquirir enfermedades que son
                ...
                <h2 className="title_section main_info_title" data-aos="fade-up">
                    Beneficiarios
                </h2>
                <p className="standard_text_section description" data-aos="fade-up">
                ...
                <p className="standard_text_section description" data-aos="fade-up">
                    ...
                    instituciones. Para la dispensación del agua en los colegios
                    BIOZONOS plantea la instalación de uno o dos bebederos según
                    lo requiera la institución para abastecer de líquido
                    totalmente pura a esta
                </p>
            </div>

            <div className="gallery_container">
                <div className="gallery_section row">
                    <h3 className="gallery_section_title title_small" data-aos="fade-up">
            ...
            <div className="characteristic_container">
                <p className="standard_text_section description" data-aos="fade-up">
                    ...
                    bebedero cuenta con un sistema de filtración, ozonización y
                    refrigeración, que garantiza un agua pura y de calidad para
                ...
                <ul>
                    <li data-aos="fade-up" className='standard_text_section'>1 punto de salida de agua.</li>
                    <li data-aos="fade-up" className='standard_text_section'>1 punto de energía a 110v</li>
                </ul>

                <p className="description standard_text_section fw-bold" data-aos="fade-up">
                    Características de las plantas:
                </p>
                <ul>
                    <li className='standard_text_section' data-aos="fade-up">14 MESES de garantía</li>
                    <li className='standard_text_section' data-aos="fade-up">
                    ...
                    <li className='standard_text_section' data-aos="fade-up">Bajo consumo hasta 15W</li>
                    <li className='standard_text_section' data-aos="fade-up">Flujo continuo hasta 8 Lt s/m</li>
                </ul>
